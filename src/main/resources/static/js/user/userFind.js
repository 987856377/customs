...
function find(){
    let oprator = $("#operator").text();
    let index = $("#select-type").val();
    let value = $("#user-input").val();
    if (oprator!=null&&oprator!=""&&index!=null&&index!=""&&value!=null&&value!="") {
        $.post("/user/find",{oprator: oprator, index:index,value:value},function (response) {
...
$btn_update.click(function () {
    ...
    let mail = $("#mail").val();
    let roles = $("#roles").val();
    if (id!=null&&id!=""&&username!=null&&username!=""&&realname!=null&&realname!=""&&
            identity!=null&&identity!=""&& phone!=null&&phone!=""&&mail!=null&&mail!="") {
